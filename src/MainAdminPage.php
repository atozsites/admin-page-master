 ...
 *
 * @package AtozWordpressAdminPage
 * @since 1.0.0
 */
class MainAdminPage extends AbstractAdminPage {
	 ...
	 * @var string
	 */
	protected $pageTitle = 'AtozWordpress Admin Menu';
	 ...
	 * @var string
	 */
	protected $title = 'AtozWordpress Admin Page';
	 ...
	 * @var string
	 */
	protected static $slug = 'AtozWordpress_admin_menu';
